...
/**
 * A02Response200UpdatedPaymentInfoNuban Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client\Mirakl
 * @author   OpenAPI Generator team
 ...
 */
class A02Response200UpdatedPaymentInfoNuban extends A02Response200UpdatedPaymentInfo
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'A02_Response_200_Updated_PaymentInfo_Nuban';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('nuban', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['nuban']) && (mb_strlen($this->container['nuban']) > 255)) {
            $invalidProperties[] = "invalid value for 'nuban', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['nuban']) && (mb_strlen($this->container['nuban']) < 10)) {
            $invalidProperties[] = "invalid value for 'nuban', the character length must be bigger than or equal to 10.";
        }
    ...
    public function setBankCity($bankCity)
    {
        ...
        if ((mb_strlen($bankCity) > 100)) {
            throw new \InvalidArgumentException('invalid length for $bankCity when calling A02Response200UpdatedPaymentInfoNuban., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($bankCity) < 3)) {
            throw new \InvalidArgumentException('invalid length for $bankCity when calling A02Response200UpdatedPaymentInfoNuban., must be bigger than or equal to 3.');
        }
    ...
    public function setBankName($bankName)
    {
        ...
        if ((mb_strlen($bankName) > 255)) {
            throw new \InvalidArgumentException('invalid length for $bankName when calling A02Response200UpdatedPaymentInfoNuban., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($bankName) < 0)) {
            throw new \InvalidArgumentException('invalid length for $bankName when calling A02Response200UpdatedPaymentInfoNuban., must be bigger than or equal to 0.');
        }
    ...
    public function setBankStreet($bankStreet)
    {
        ...
        if ((mb_strlen($bankStreet) > 100)) {
            throw new \InvalidArgumentException('invalid length for $bankStreet when calling A02Response200UpdatedPaymentInfoNuban., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($bankStreet) < 3)) {
            throw new \InvalidArgumentException('invalid length for $bankStreet when calling A02Response200UpdatedPaymentInfoNuban., must be bigger than or equal to 3.');
        }
    ...
    public function setBankZip($bankZip)
    {
        ...
        if ((mb_strlen($bankZip) > 255)) {
            throw new \InvalidArgumentException('invalid length for $bankZip when calling A02Response200UpdatedPaymentInfoNuban., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($bankZip) < 0)) {
            throw new \InvalidArgumentException('invalid length for $bankZip when calling A02Response200UpdatedPaymentInfoNuban., must be bigger than or equal to 0.');
        }
    ...
    {
        return $this->container['nuban'];
    }

    /**
     * Sets nuban
     *
     * @param string|null $nuban The bank account NUBAN code
     *
     * @return self
     */
    ...
    {
        if (is_null($nuban)) {
            throw new \InvalidArgumentException('non-nullable nuban cannot be null');
        }
        if ((mb_strlen($nuban) > 255)) {
            throw new \InvalidArgumentException('invalid length for $nuban when calling A02Response200UpdatedPaymentInfoNuban., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($nuban) < 10)) {
            throw new \InvalidArgumentException('invalid length for $nuban when calling A02Response200UpdatedPaymentInfoNuban., must be bigger than or equal to 10.');
        }

        $this->container['nuban'] = $nuban;
