...
class ProductCategoriesImportFileResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'idImportFile' => 'int',
        'uri' => 'string',
        'status' => '\OpenAPI\Client\Mirakl\Model\ProductCategoriesImportFileStatus',
        'note' => 'string',
        'totalLines' => 'float',
        'currentLine' => 'float',
        'tsCreated' => 'string',
    ...
    */
     ...
     * Gets status
     *
     * @return \OpenAPI\Client\Mirakl\Model\ProductCategoriesImportFileStatus
     */
     ...
     * Sets status
     *
     * @param \OpenAPI\Client\Mirakl\Model\ProductCategoriesImportFileStatus $status status
     *
     * @return self
     */
