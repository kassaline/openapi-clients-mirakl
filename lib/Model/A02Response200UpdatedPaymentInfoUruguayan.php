...
/**
 * A02Response200UpdatedPaymentInfoUruguayan Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client\Mirakl
 * @author   OpenAPI Generator team
 ...
 */
class A02Response200UpdatedPaymentInfoUruguayan extends A02Response200UpdatedPaymentInfo
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'A02_Response_200_Updated_PaymentInfo_Uruguayan';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['accountNumber']) && (mb_strlen($this->container['accountNumber']) > 20)) {
            $invalidProperties[] = "invalid value for 'accountNumber', the character length must be smaller than or equal to 20.";
        }

        if (!is_null($this->container['accountNumber']) && (mb_strlen($this->container['accountNumber']) < 5)) {
            $invalidProperties[] = "invalid value for 'accountNumber', the character length must be bigger than or equal to 5.";
        }
        ...
        if (!is_null($this->container['branchCode']) && (mb_strlen($this->container['branchCode']) > 10)) {
            $invalidProperties[] = "invalid value for 'branchCode', the character length must be smaller than or equal to 10.";
        }
    ...
    public function setAccountNumber($accountNumber)
    {
        ...
        if ((mb_strlen($accountNumber) > 20)) {
            throw new \InvalidArgumentException('invalid length for $accountNumber when calling A02Response200UpdatedPaymentInfoUruguayan., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($accountNumber) < 5)) {
            throw new \InvalidArgumentException('invalid length for $accountNumber when calling A02Response200UpdatedPaymentInfoUruguayan., must be bigger than or equal to 5.');
        }
        if ((!preg_match("/[0-9]+/", ObjectSerializer::toString($accountNumber)))) {
            throw new \InvalidArgumentException("invalid value for \$accountNumber when calling A02Response200UpdatedPaymentInfoUruguayan., must conform to the pattern /[0-9]+/.");
        }
    ...
    public function setBankCity($bankCity)
    {
        ...
        if ((mb_strlen($bankCity) > 100)) {
            throw new \InvalidArgumentException('invalid length for $bankCity when calling A02Response200UpdatedPaymentInfoUruguayan., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($bankCity) < 3)) {
            throw new \InvalidArgumentException('invalid length for $bankCity when calling A02Response200UpdatedPaymentInfoUruguayan., must be bigger than or equal to 3.');
        }
    ...
    public function setBankName($bankName)
    {
        ...
        if ((mb_strlen($bankName) > 255)) {
            throw new \InvalidArgumentException('invalid length for $bankName when calling A02Response200UpdatedPaymentInfoUruguayan., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($bankName) < 0)) {
            throw new \InvalidArgumentException('invalid length for $bankName when calling A02Response200UpdatedPaymentInfoUruguayan., must be bigger than or equal to 0.');
        }
    ...
    public function setBankStreet($bankStreet)
    {
        ...
        if ((mb_strlen($bankStreet) > 100)) {
            throw new \InvalidArgumentException('invalid length for $bankStreet when calling A02Response200UpdatedPaymentInfoUruguayan., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($bankStreet) < 3)) {
            throw new \InvalidArgumentException('invalid length for $bankStreet when calling A02Response200UpdatedPaymentInfoUruguayan., must be bigger than or equal to 3.');
        }
    ...
    public function setBankZip($bankZip)
    {
        ...
        if ((mb_strlen($bankZip) > 255)) {
            throw new \InvalidArgumentException('invalid length for $bankZip when calling A02Response200UpdatedPaymentInfoUruguayan., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($bankZip) < 0)) {
            throw new \InvalidArgumentException('invalid length for $bankZip when calling A02Response200UpdatedPaymentInfoUruguayan., must be bigger than or equal to 0.');
        }
    ...
    public function setBranchCode($branchCode)
    {
        ...
        if ((mb_strlen($branchCode) > 10)) {
            throw new \InvalidArgumentException('invalid length for $branchCode when calling A02Response200UpdatedPaymentInfoUruguayan., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($branchCode) < 1)) {
            throw new \InvalidArgumentException('invalid length for $branchCode when calling A02Response200UpdatedPaymentInfoUruguayan., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/[0-9]+/", ObjectSerializer::toString($branchCode)))) {
            throw new \InvalidArgumentException("invalid value for \$branchCode when calling A02Response200UpdatedPaymentInfoUruguayan., must conform to the pattern /[0-9]+/.");
        }
