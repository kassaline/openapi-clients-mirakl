...
class CreateShipmentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'carrier' => 'string',
        'items' => '\OpenAPI\Client\Mirakl\Model\CreateShipmentItemRequest[]',
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['carrier']) && (mb_strlen($this->container['carrier']) < 1)) {
    ...
    public function setCarrier($carrier)
    {
        ...
        if ((mb_strlen($carrier) < 1)) {
            throw new \InvalidArgumentException('invalid length for $carrier when calling CreateShipmentRequest., must be bigger than or equal to 1.');
        }
     ...
     * Gets items
     *
     * @return \OpenAPI\Client\Mirakl\Model\CreateShipmentItemRequest[]|null
     */
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\Mirakl\Model\CreateShipmentItemRequest[]|null $items Shipment items
     *
     * @return self
     */
    ...
    public function setTrackingNumber($trackingNumber)
    {
        ...
        if ((mb_strlen($trackingNumber) < 1)) {
            throw new \InvalidArgumentException('invalid length for $trackingNumber when calling CreateShipmentRequest., must be bigger than or equal to 1.');
        }
