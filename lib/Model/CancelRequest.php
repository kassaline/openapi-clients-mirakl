...
class CancelRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'shippingTaxes' => '\OpenAPI\Client\Mirakl\Model\CanceledTaxRequest[]',
        'taxes' => '\OpenAPI\Client\Mirakl\Model\CanceledTaxRequest[]'
    ];
    ...
    */
     ...
     * Sets orderLineId
     *
     * @param string|null $orderLineId Unique order line identifier used by Mirakl Connect. ID of the order line to cancel.
     *
     * @return self
     */
    public function setOrderLineId($orderLineId)
    {
        ...
        if ((mb_strlen($orderLineId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $orderLineId when calling CancelRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets price
     *
     * @param \OpenAPI\Client\Mirakl\Model\Money|null $price Product price to cancel, excluding taxes and shipping price
     *
     * @return self
     */
    ...
    public function setProductId($productId)
    {
        ...
        if ((mb_strlen($productId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $productId when calling CancelRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets quantity
     *
     * @param int|null $quantity Product quantity to cancel
     *
     * @return self
     */
    public function setQuantity($quantity)
    {
        ...
        if (($quantity < 0)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling CancelRequest., must be bigger than or equal to 0.');
        }
     ...
     * Sets reason
     *
     * @param string|null $reason The reason why the order line is canceled
     *
     * @return self
     */
     ...
     * Sets shippingPrice
     *
     * @param \OpenAPI\Client\Mirakl\Model\Money|null $shippingPrice Shipping price to cancel, excluding shipping taxes
     *
     * @return self
     */
     ...
     * Gets shippingTaxes
     *
     * @return \OpenAPI\Client\Mirakl\Model\CanceledTaxRequest[]|null
     */
     ...
     * Sets shippingTaxes
     *
     * @param \OpenAPI\Client\Mirakl\Model\CanceledTaxRequest[]|null $shippingTaxes Shipping taxes to cancel
     *
     * @return self
     */
     ...
     * Sets taxes
     *
     * @param \OpenAPI\Client\Mirakl\Model\CanceledTaxRequest[]|null $taxes Taxes to cancel
     *
     * @return self
     */
