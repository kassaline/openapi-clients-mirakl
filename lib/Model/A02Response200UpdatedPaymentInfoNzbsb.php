...
/**
 * A02Response200UpdatedPaymentInfoNzbsb Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client\Mirakl
 * @author   OpenAPI Generator team
 ...
 */
class A02Response200UpdatedPaymentInfoNzbsb extends A02Response200UpdatedPaymentInfo
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'A02_Response_200_Updated_PaymentInfo_Nzbsb';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('nzban', $data ?? [], null);
        $this->setIfExists('nzbsb', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['nzban']) && (mb_strlen($this->container['nzban']) > 10)) {
            $invalidProperties[] = "invalid value for 'nzban', the character length must be smaller than or equal to 10.";
        }

        if (!is_null($this->container['nzban']) && (mb_strlen($this->container['nzban']) < 10)) {
            $invalidProperties[] = "invalid value for 'nzban', the character length must be bigger than or equal to 10.";
        }
    ...
    public function setBankCity($bankCity)
    {
        ...
        if ((mb_strlen($bankCity) > 100)) {
            throw new \InvalidArgumentException('invalid length for $bankCity when calling A02Response200UpdatedPaymentInfoNzbsb., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($bankCity) < 3)) {
            throw new \InvalidArgumentException('invalid length for $bankCity when calling A02Response200UpdatedPaymentInfoNzbsb., must be bigger than or equal to 3.');
        }
    ...
    public function setBankName($bankName)
    {
        ...
        if ((mb_strlen($bankName) > 255)) {
            throw new \InvalidArgumentException('invalid length for $bankName when calling A02Response200UpdatedPaymentInfoNzbsb., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($bankName) < 0)) {
            throw new \InvalidArgumentException('invalid length for $bankName when calling A02Response200UpdatedPaymentInfoNzbsb., must be bigger than or equal to 0.');
        }
    ...
    public function setBankStreet($bankStreet)
    {
        ...
        if ((mb_strlen($bankStreet) > 100)) {
            throw new \InvalidArgumentException('invalid length for $bankStreet when calling A02Response200UpdatedPaymentInfoNzbsb., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($bankStreet) < 3)) {
            throw new \InvalidArgumentException('invalid length for $bankStreet when calling A02Response200UpdatedPaymentInfoNzbsb., must be bigger than or equal to 3.');
        }
    ...
    public function setBankZip($bankZip)
    {
        ...
        if ((mb_strlen($bankZip) > 255)) {
            throw new \InvalidArgumentException('invalid length for $bankZip when calling A02Response200UpdatedPaymentInfoNzbsb., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($bankZip) < 0)) {
            throw new \InvalidArgumentException('invalid length for $bankZip when calling A02Response200UpdatedPaymentInfoNzbsb., must be bigger than or equal to 0.');
        }
     ...
     * @return string|null
     */
    public function getNzban()
    {
        return $this->container['nzban'];
    }

    /**
     * Sets nzban
     *
     * @param string|null $nzban Bank Account Number
     *
     * @return self
     */
    public function setNzban($nzban)
    {
        if (is_null($nzban)) {
            throw new \InvalidArgumentException('non-nullable nzban cannot be null');
        }
        if ((mb_strlen($nzban) > 10)) {
            throw new \InvalidArgumentException('invalid length for $nzban when calling A02Response200UpdatedPaymentInfoNzbsb., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($nzban) < 10)) {
            throw new \InvalidArgumentException('invalid length for $nzban when calling A02Response200UpdatedPaymentInfoNzbsb., must be bigger than or equal to 10.');
        }

        $this->container['nzban'] = $nzban;
     ...
     * @return string|null
     */
    public function getNzbsb()
    {
        return $this->container['nzbsb'];
    }

    /**
     * Sets nzbsb
     *
     * @param string|null $nzbsb Bank State Branch code.
     *
     * @return self
     */
    public function setNzbsb($nzbsb)
    {
        if (is_null($nzbsb)) {
            throw new \InvalidArgumentException('non-nullable nzbsb cannot be null');
        }
        $this->container['nzbsb'] = $nzbsb;
