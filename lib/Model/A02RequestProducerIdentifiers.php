...
/**
 * A02RequestProducerIdentifiers Class Doc Comment
 *
 * @category Class
 ...
 */
class A02RequestProducerIdentifiers implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'A02_Request_ProducerIdentifiers';
    ...
    */
    ...
    public function setEprCategoryCode($eprCategoryCode)
    {
        ...
        if ((mb_strlen($eprCategoryCode) > 255)) {
            throw new \InvalidArgumentException('invalid length for $eprCategoryCode when calling A02RequestProducerIdentifiers., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($eprCategoryCode) < 0)) {
            throw new \InvalidArgumentException('invalid length for $eprCategoryCode when calling A02RequestProducerIdentifiers., must be bigger than or equal to 0.');
        }
    ...
    public function setProducerId($producerId)
    {
        ...
        if ((mb_strlen($producerId) > 255)) {
            throw new \InvalidArgumentException('invalid length for $producerId when calling A02RequestProducerIdentifiers., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($producerId) < 0)) {
            throw new \InvalidArgumentException('invalid length for $producerId when calling A02RequestProducerIdentifiers., must be bigger than or equal to 0.');
        }
