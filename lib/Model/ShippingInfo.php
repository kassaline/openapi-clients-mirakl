...
class ShippingInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'address' => '\OpenAPI\Client\Mirakl\Model\Address',
        'carrier' => 'string',
        'deliveryDate' => '\OpenAPI\Client\Mirakl\Model\ShippingInfoDeliveryDate',
        'email' => 'string',
        'method' => 'string',
        'pudoId' => 'string',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('pudoId', $data ?? [], null);
    ...
    */
     ...
     * Gets address
     *
     * @return \OpenAPI\Client\Mirakl\Model\Address|null
     */
     ...
     * Sets address
     *
     * @param \OpenAPI\Client\Mirakl\Model\Address|null $address address
     *
     * @return self
     */
     ...
     * Gets deliveryDate
     *
     * @return \OpenAPI\Client\Mirakl\Model\ShippingInfoDeliveryDate|null
     */
     ...
     * Sets deliveryDate
     *
     * @param \OpenAPI\Client\Mirakl\Model\ShippingInfoDeliveryDate|null $deliveryDate deliveryDate
     *
     * @return self
     */
    ...
    {
        return $this->container['pudoId'];
    }

    /**
     * Sets pudoId
     *
     * @param string|null $pudoId PickUp DropOff (PUDO) point identifier
     *
     * @return self
     */
    ...
    {
        if (is_null($pudoId)) {
            throw new \InvalidArgumentException('non-nullable pudoId cannot be null');
        }
        $this->container['pudoId'] = $pudoId;
     ...
     *
     * @param \DateTime|null $shippingDeadline Date time by which the store must send the order to the customer.
     *
     * @return self
     */
