...
/**
 * PRI02Response200Data Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client\Mirakl
 * @author   OpenAPI Generator team
 ...
 */
class PRI02Response200Data implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PRI02_Response_200_Data';
    ...
    protected static $setters = [
        ...
        'offersInError' => 'setOffersInError',
        'offersUpdated' => 'setOffersUpdated',
        'origin' => 'setOrigin',
    ...
    protected static $getters = [
        ...
        'offersInError' => 'getOffersInError',
        'offersUpdated' => 'getOffersUpdated',
        'origin' => 'getOrigin',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('offersInError', $data ?? [], null);
        $this->setIfExists('offersUpdated', $data ?? [], null);
    ...
    */
     ...
     * @return int|null
     */
    public function getOffersInError()
    {
        return $this->container['offersInError'];
    }

    /**
     * Sets offersInError
     *
     * @param int|null $offersInError Total count of offers in error
     *
     * @return self
     */
    public function setOffersInError($offersInError)
    {
        if (is_null($offersInError)) {
            throw new \InvalidArgumentException('non-nullable offersInError cannot be null');
        }
        $this->container['offersInError'] = $offersInError;
    ...
    {
        return $this->container['offersUpdated'];
    }

    /**
     * Sets offersUpdated
     *
     * @param int|null $offersUpdated Total count of updated offers
     *
     * @return self
     */
    public function setOffersUpdated($offersUpdated)
    {
        if (is_null($offersUpdated)) {
            throw new \InvalidArgumentException('non-nullable offersUpdated cannot be null');
        }
        $this->container['offersUpdated'] = $offersUpdated;
