...
/**
 * A02Response200UpdatedPaymentInfoSerbian Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client\Mirakl
 * @author   OpenAPI Generator team
 ...
 */
class A02Response200UpdatedPaymentInfoSerbian extends A02Response200UpdatedPaymentInfo
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'A02_Response_200_Updated_PaymentInfo_Serbian';
    ...
    protected static $attributeMap = [
        ...
        'bankBranchNumber' => 'bank_branch_number',
        'bankCity' => 'bank_city',
        'bankName' => 'bank_name',
    ...
    protected static $setters = [
        ...
        'bankBranchNumber' => 'setBankBranchNumber',
    ...
    protected static $getters = [
        ...
        'bankBranchNumber' => 'getBankBranchNumber',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('bankBranchNumber', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['bankBranchNumber']) && (mb_strlen($this->container['bankBranchNumber']) > 10)) {
            $invalidProperties[] = "invalid value for 'bankBranchNumber', the character length must be smaller than or equal to 10.";
        }

        if (!is_null($this->container['bankBranchNumber']) && (mb_strlen($this->container['bankBranchNumber']) < 1)) {
            $invalidProperties[] = "invalid value for 'bankBranchNumber', the character length must be bigger than or equal to 1.";
        }
    ...
    public function setBankAccountNumber($bankAccountNumber)
    {
        ...
        if ((!preg_match("/[0-9]+/", ObjectSerializer::toString($bankAccountNumber)))) {
            throw new \InvalidArgumentException("invalid value for \$bankAccountNumber when calling A02Response200UpdatedPaymentInfoSerbian., must conform to the pattern /[0-9]+/.");
        }
    ...
    /**
     * Gets bankBranchNumber
     *
     * @return string|null
     */
    public function getBankBranchNumber()
    {
        return $this->container['bankBranchNumber'];
    }

    /**
     * Sets bankBranchNumber
     *
     * @param string|null $bankBranchNumber Bank branch number
     *
     * @return self
     */
    public function setBankBranchNumber($bankBranchNumber)
    {
        if (is_null($bankBranchNumber)) {
            throw new \InvalidArgumentException('non-nullable bankBranchNumber cannot be null');
        }
        if ((mb_strlen($bankBranchNumber) > 10)) {
            throw new \InvalidArgumentException('invalid length for $bankBranchNumber when calling A02Response200UpdatedPaymentInfoSerbian., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($bankBranchNumber) < 1)) {
            throw new \InvalidArgumentException('invalid length for $bankBranchNumber when calling A02Response200UpdatedPaymentInfoSerbian., must be bigger than or equal to 1.');
        }

        $this->container['bankBranchNumber'] = $bankBranchNumber;
    ...
    public function setBankCity($bankCity)
    {
        ...
        if ((mb_strlen($bankCity) > 100)) {
            throw new \InvalidArgumentException('invalid length for $bankCity when calling A02Response200UpdatedPaymentInfoSerbian., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($bankCity) < 3)) {
            throw new \InvalidArgumentException('invalid length for $bankCity when calling A02Response200UpdatedPaymentInfoSerbian., must be bigger than or equal to 3.');
        }
    ...
    public function setBankName($bankName)
    {
        ...
        if ((mb_strlen($bankName) > 255)) {
            throw new \InvalidArgumentException('invalid length for $bankName when calling A02Response200UpdatedPaymentInfoSerbian., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($bankName) < 0)) {
            throw new \InvalidArgumentException('invalid length for $bankName when calling A02Response200UpdatedPaymentInfoSerbian., must be bigger than or equal to 0.');
        }
    ...
    public function setBankStreet($bankStreet)
    {
        ...
        if ((mb_strlen($bankStreet) > 100)) {
            throw new \InvalidArgumentException('invalid length for $bankStreet when calling A02Response200UpdatedPaymentInfoSerbian., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($bankStreet) < 3)) {
            throw new \InvalidArgumentException('invalid length for $bankStreet when calling A02Response200UpdatedPaymentInfoSerbian., must be bigger than or equal to 3.');
        }
    ...
    public function setBankZip($bankZip)
    {
        ...
        if ((mb_strlen($bankZip) > 255)) {
            throw new \InvalidArgumentException('invalid length for $bankZip when calling A02Response200UpdatedPaymentInfoSerbian., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($bankZip) < 0)) {
            throw new \InvalidArgumentException('invalid length for $bankZip when calling A02Response200UpdatedPaymentInfoSerbian., must be bigger than or equal to 0.');
        }
