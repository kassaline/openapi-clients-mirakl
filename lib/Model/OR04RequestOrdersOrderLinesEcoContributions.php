<?php
/**
 * OR04RequestOrdersOrderLinesEcoContributions
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * OR04RequestOrdersOrderLinesEcoContributions Class Doc Comment
 *
 * @category Class
 ...
 */
class OR04RequestOrdersOrderLinesEcoContributions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OR04_Request_Orders_OrderLines_EcoContributions';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['unitAmount']) && ($this->container['unitAmount'] > 100000000000000000)) {
            $invalidProperties[] = "invalid value for 'unitAmount', must be smaller than or equal to 100000000000000000.";
        }
     ...
     * Sets producerId
     *
     * @param string|null $producerId Producer identifier of the eco-contribution
     *
     * @return self
     */
    public function setProducerId($producerId)
    {
        ...
        if ((mb_strlen($producerId) > 255)) {
            throw new \InvalidArgumentException('invalid length for $producerId when calling OR04RequestOrdersOrderLinesEcoContributions., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($producerId) < 0)) {
            throw new \InvalidArgumentException('invalid length for $producerId when calling OR04RequestOrdersOrderLinesEcoContributions., must be bigger than or equal to 0.');
        }
    ...
    public function setUnitAmount($unitAmount)
    {
        ...
        if (($unitAmount > 100000000000000000)) {
            throw new \InvalidArgumentException('invalid value for $unitAmount when calling OR04RequestOrdersOrderLinesEcoContributions., must be smaller than or equal to 100000000000000000.');
        }
