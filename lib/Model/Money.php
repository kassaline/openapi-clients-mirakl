...
class Money implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setAmount($amount)
    {
        ...
        if (($amount < 0)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling Money., must be bigger than or equal to 0.');
        }
     ...
     * Sets currency
     *
     * @param string|null $currency Currency ISO code
     *
     * @return self
     */
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) < 1)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling Money., must be bigger than or equal to 1.');
        }
