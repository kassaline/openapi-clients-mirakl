<?php
/**
 * ST12Response200DataShipmentLines
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ST12Response200DataShipmentLines Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client\Mirakl
 * @author   OpenAPI Generator team
 ...
 */
class ST12Response200DataShipmentLines implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ST12_Response_200_Data_ShipmentLines';
    ...
    protected static $setters = [
        ...
        'packageReference' => 'setPackageReference',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('packageReference', $data ?? [], null);
    ...
    */
     ...
     * Sets offerSku
     *
     * @param string|null $offerSku Offer sku
     *
     * @return self
     */
     ...
     *
     * @param string|null $packageDescription Package Description
     *
     * @return self
     * @deprecated
     */
    public function setPackageDescription($packageDescription)
    {
        if (is_null($packageDescription)) {
            throw new \InvalidArgumentException('non-nullable packageDescription cannot be null');
        }
    ...
    /**
     * Gets packageReference
     *
     * @return string|null
     */
    public function getPackageReference()
    {
        return $this->container['packageReference'];
    }

    /**
     * Sets packageReference
     *
     * @param string|null $packageReference Package reference
     *
     * @return self
     */
    public function setPackageReference($packageReference)
    {
        if (is_null($packageReference)) {
            throw new \InvalidArgumentException('non-nullable packageReference cannot be null');
        }
        $this->container['packageReference'] = $packageReference;
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity < 1)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling ST12Response200DataShipmentLines., must be bigger than or equal to 1.');
        }
