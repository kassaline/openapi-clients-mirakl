...
/**
 * A02Response200UpdatedPaymentInfoUk Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client\Mirakl
 * @author   OpenAPI Generator team
 ...
 */
class A02Response200UpdatedPaymentInfoUk extends A02Response200UpdatedPaymentInfo
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'A02_Response_200_Updated_PaymentInfo_Uk';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['bankAccountNumber']) && (mb_strlen($this->container['bankAccountNumber']) > 11)) {
            $invalidProperties[] = "invalid value for 'bankAccountNumber', the character length must be smaller than or equal to 11.";
        }
        ...
        if (!is_null($this->container['bankSortCode']) && !preg_match("/[0-9]+/", $this->container['bankSortCode'])) {
            $invalidProperties[] = "invalid value for 'bankSortCode', must be conform to the pattern /[0-9]+/.";
        }
    ...
    public function setBankAccountNumber($bankAccountNumber)
    {
        ...
        if ((mb_strlen($bankAccountNumber) > 11)) {
            throw new \InvalidArgumentException('invalid length for $bankAccountNumber when calling A02Response200UpdatedPaymentInfoUk., must be smaller than or equal to 11.');
        }
        if ((mb_strlen($bankAccountNumber) < 6)) {
            throw new \InvalidArgumentException('invalid length for $bankAccountNumber when calling A02Response200UpdatedPaymentInfoUk., must be bigger than or equal to 6.');
        }
        if ((!preg_match("/[0-9]+/", ObjectSerializer::toString($bankAccountNumber)))) {
            throw new \InvalidArgumentException("invalid value for \$bankAccountNumber when calling A02Response200UpdatedPaymentInfoUk., must conform to the pattern /[0-9]+/.");
        }
    ...
    public function setBankCity($bankCity)
    {
        ...
        if ((mb_strlen($bankCity) > 100)) {
            throw new \InvalidArgumentException('invalid length for $bankCity when calling A02Response200UpdatedPaymentInfoUk., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($bankCity) < 3)) {
            throw new \InvalidArgumentException('invalid length for $bankCity when calling A02Response200UpdatedPaymentInfoUk., must be bigger than or equal to 3.');
        }
    ...
    public function setBankName($bankName)
    {
        ...
        if ((mb_strlen($bankName) > 255)) {
            throw new \InvalidArgumentException('invalid length for $bankName when calling A02Response200UpdatedPaymentInfoUk., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($bankName) < 0)) {
            throw new \InvalidArgumentException('invalid length for $bankName when calling A02Response200UpdatedPaymentInfoUk., must be bigger than or equal to 0.');
        }
     ...
     * Sets bankSortCode
     *
     * @param string|null $bankSortCode Bank Sort Code (Size must be 6 digits)
     *
     * @return self
     */
    public function setBankSortCode($bankSortCode)
    {
        if (is_null($bankSortCode)) {
            throw new \InvalidArgumentException('non-nullable bankSortCode cannot be null');
        }

        if ((!preg_match("/[0-9]+/", ObjectSerializer::toString($bankSortCode)))) {
            throw new \InvalidArgumentException("invalid value for \$bankSortCode when calling A02Response200UpdatedPaymentInfoUk., must conform to the pattern /[0-9]+/.");
        }
    ...
    public function setBankStreet($bankStreet)
    {
        ...
        if ((mb_strlen($bankStreet) > 100)) {
            throw new \InvalidArgumentException('invalid length for $bankStreet when calling A02Response200UpdatedPaymentInfoUk., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($bankStreet) < 3)) {
            throw new \InvalidArgumentException('invalid length for $bankStreet when calling A02Response200UpdatedPaymentInfoUk., must be bigger than or equal to 3.');
        }
    ...
    public function setBankZip($bankZip)
    {
        ...
        if ((mb_strlen($bankZip) > 255)) {
            throw new \InvalidArgumentException('invalid length for $bankZip when calling A02Response200UpdatedPaymentInfoUk., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($bankZip) < 0)) {
            throw new \InvalidArgumentException('invalid length for $bankZip when calling A02Response200UpdatedPaymentInfoUk., must be bigger than or equal to 0.');
        }
