...
/**
 * A02Response200UpdatedPaymentInfo Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client\Mirakl
 * @author   OpenAPI Generator team
 ...
 */
class A02Response200UpdatedPaymentInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = 'atType';
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'A02_Response_200_Updated_PaymentInfo';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->container['atType'] = static::$openAPIModelName;
    }
    ...
    */
    ...
    public function setOwner($owner)
    {
        ...
        if ((mb_strlen($owner) > 100)) {
            throw new \InvalidArgumentException('invalid length for $owner when calling A02Response200UpdatedPaymentInfo., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($owner) < 3)) {
            throw new \InvalidArgumentException('invalid length for $owner when calling A02Response200UpdatedPaymentInfo., must be bigger than or equal to 3.');
        }
