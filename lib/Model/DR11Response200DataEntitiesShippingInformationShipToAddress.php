<?php
/**
 * DR11Response200DataEntitiesShippingInformationShipToAddress
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * DR11Response200DataEntitiesShippingInformationShipToAddress Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client\Mirakl
 * @author   OpenAPI Generator team
 ...
 */
class DR11Response200DataEntitiesShippingInformationShipToAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DR11_Response_200_Data_Entities_ShippingInformation_ShipToAddress';
    ...
    */
     ...
     * Sets civility
     *
     * @param string|null $civility The civility of the recipient (e.g., Mr., Mrs., Dr.)
     *
     * @return self
     */
     ...
     * Sets company
     *
     * @param string|null $company The company name of the shipping address
     *
     * @return self
     */
     ...
     * Sets company2
     *
     * @param string|null $company2 The secondary company name of the shipping address
     *
     * @return self
     */
     ...
     * Sets countryIsoCode
     *
     * @param string|null $countryIsoCode The ISO country code of the shipping address
     *
     * @return self
     */
     ...
     * Sets firstname
     *
     * @param string|null $firstname The first name of the recipient
     *
     * @return self
     */
     ...
     * Sets lastname
     *
     * @param string|null $lastname The last name of the recipient
     *
     * @return self
     */
     ...
     * Sets phone
     *
     * @param string|null $phone The phone number of the recipient
     *
     * @return self
     */
     ...
     * Sets phoneSecondary
     *
     * @param string|null $phoneSecondary The secondary phone number of the recipient
     *
     * @return self
     */
     ...
     * Sets street1
     *
     * @param string|null $street1 The first line of the street address
     *
     * @return self
     */
     ...
     * Sets street2
     *
     * @param string|null $street2 The second line of the street address
     *
     * @return self
     */
     ...
     * Sets zipCode
     *
     * @param string|null $zipCode The zip code of the shipping address
     *
     * @return self
     */
