    ...
    */
    ...
    public function setBankAccountNumber($bankAccountNumber)
    {
        ...
        if ((mb_strlen($bankAccountNumber) > 12)) {
            throw new \InvalidArgumentException('invalid length for $bankAccountNumber when calling A02RequestPaymentInfoSg., must be smaller than or equal to 12.');
        }
        if ((mb_strlen($bankAccountNumber) < 9)) {
            throw new \InvalidArgumentException('invalid length for $bankAccountNumber when calling A02RequestPaymentInfoSg., must be bigger than or equal to 9.');
        }
        if ((!preg_match("/[0-9]+/", ObjectSerializer::toString($bankAccountNumber)))) {
            throw new \InvalidArgumentException("invalid value for \$bankAccountNumber when calling A02RequestPaymentInfoSg., must conform to the pattern /[0-9]+/.");
        }
    ...
    public function setBankCity($bankCity)
    {
        ...
        if ((mb_strlen($bankCity) > 100)) {
            throw new \InvalidArgumentException('invalid length for $bankCity when calling A02RequestPaymentInfoSg., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($bankCity) < 3)) {
            throw new \InvalidArgumentException('invalid length for $bankCity when calling A02RequestPaymentInfoSg., must be bigger than or equal to 3.');
        }
    ...
    public function setBankKey($bankKey)
    {
        ...
        if ((!preg_match("/[0-9]+/", ObjectSerializer::toString($bankKey)))) {
            throw new \InvalidArgumentException("invalid value for \$bankKey when calling A02RequestPaymentInfoSg., must conform to the pattern /[0-9]+/.");
        }
    ...
    public function setBankName($bankName)
    {
        ...
        if ((mb_strlen($bankName) > 255)) {
            throw new \InvalidArgumentException('invalid length for $bankName when calling A02RequestPaymentInfoSg., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($bankName) < 0)) {
            throw new \InvalidArgumentException('invalid length for $bankName when calling A02RequestPaymentInfoSg., must be bigger than or equal to 0.');
        }
    ...
    public function setBankStreet($bankStreet)
    {
        ...
        if ((mb_strlen($bankStreet) > 100)) {
            throw new \InvalidArgumentException('invalid length for $bankStreet when calling A02RequestPaymentInfoSg., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($bankStreet) < 3)) {
            throw new \InvalidArgumentException('invalid length for $bankStreet when calling A02RequestPaymentInfoSg., must be bigger than or equal to 3.');
        }
    ...
    public function setBankZip($bankZip)
    {
        ...
        if ((mb_strlen($bankZip) > 255)) {
            throw new \InvalidArgumentException('invalid length for $bankZip when calling A02RequestPaymentInfoSg., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($bankZip) < 0)) {
            throw new \InvalidArgumentException('invalid length for $bankZip when calling A02RequestPaymentInfoSg., must be bigger than or equal to 0.');
        }
