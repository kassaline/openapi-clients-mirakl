...
class OR04RequestOrdersOrderLines implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'ecoContributions' => '\OpenAPI\Client\Mirakl\Model\OR04RequestOrdersOrderLinesEcoContributions[]',
        'orderLineId' => 'string'
    ];
    ...
    */
     ...
     *
     * @return \OpenAPI\Client\Mirakl\Model\OR04RequestOrdersOrderLinesEcoContributions[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Mirakl\Model\OR04RequestOrdersOrderLinesEcoContributions[]|null $ecoContributions Eco-contributions to add or update on the order line - only available if the operator setting Activate data collection related to circular economy regulations has been enabled.
     *
     * @return self
     */
