<?php
/**
 * OF24RequestOffersAllPricesVolumePrices
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * OF24RequestOffersAllPricesVolumePrices Class Doc Comment
 *
 * @category Class
 ...
 */
class OF24RequestOffersAllPricesVolumePrices implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OF24_Request_Offers_AllPrices_VolumePrices';
    ...
    */
     ...
     *
     * @param int|null $quantityThreshold The quantity threshold from which the volume price is applicable
     *
     * @return self
     */
     ...
     *
     * @param float|null $unitDiscountPrice The unit discount price, i.e. the unit price when the discount applies
     *
     * @return self
     */
     ...
     *
     * @param float|null $unitOriginPrice The unit original price, i.e. the unit price excluding discounts
     *
     * @return self
     */
