...
/**
 * A01Response200PaymentInfoBrazilian Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client\Mirakl
 * @author   OpenAPI Generator team
 ...
 */
class A01Response200PaymentInfoBrazilian extends A01Response200PaymentInfo
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'A01_Response_200_PaymentInfo_Brazilian';
    ...
    */
    ...
    public function setAccountNumber($accountNumber)
    {
        ...
        if ((mb_strlen($accountNumber) > 11)) {
            throw new \InvalidArgumentException('invalid length for $accountNumber when calling A01Response200PaymentInfoBrazilian., must be smaller than or equal to 11.');
        }
        if ((mb_strlen($accountNumber) < 10)) {
            throw new \InvalidArgumentException('invalid length for $accountNumber when calling A01Response200PaymentInfoBrazilian., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/[0-9]+/", ObjectSerializer::toString($accountNumber)))) {
            throw new \InvalidArgumentException("invalid value for \$accountNumber when calling A01Response200PaymentInfoBrazilian., must conform to the pattern /[0-9]+/.");
        }
    ...
    public function setBankCity($bankCity)
    {
        ...
        if ((mb_strlen($bankCity) > 100)) {
            throw new \InvalidArgumentException('invalid length for $bankCity when calling A01Response200PaymentInfoBrazilian., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($bankCity) < 3)) {
            throw new \InvalidArgumentException('invalid length for $bankCity when calling A01Response200PaymentInfoBrazilian., must be bigger than or equal to 3.');
        }
    ...
    public function setBankCode($bankCode)
    {
        ...
        if ((!preg_match("/[0-9]+/", ObjectSerializer::toString($bankCode)))) {
            throw new \InvalidArgumentException("invalid value for \$bankCode when calling A01Response200PaymentInfoBrazilian., must conform to the pattern /[0-9]+/.");
        }
    ...
    public function setBankName($bankName)
    {
        ...
        if ((mb_strlen($bankName) > 255)) {
            throw new \InvalidArgumentException('invalid length for $bankName when calling A01Response200PaymentInfoBrazilian., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($bankName) < 0)) {
            throw new \InvalidArgumentException('invalid length for $bankName when calling A01Response200PaymentInfoBrazilian., must be bigger than or equal to 0.');
        }
    ...
    public function setBankStreet($bankStreet)
    {
        ...
        if ((mb_strlen($bankStreet) > 100)) {
            throw new \InvalidArgumentException('invalid length for $bankStreet when calling A01Response200PaymentInfoBrazilian., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($bankStreet) < 3)) {
            throw new \InvalidArgumentException('invalid length for $bankStreet when calling A01Response200PaymentInfoBrazilian., must be bigger than or equal to 3.');
        }
    ...
    public function setBankZip($bankZip)
    {
        ...
        if ((mb_strlen($bankZip) > 255)) {
            throw new \InvalidArgumentException('invalid length for $bankZip when calling A01Response200PaymentInfoBrazilian., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($bankZip) < 0)) {
            throw new \InvalidArgumentException('invalid length for $bankZip when calling A01Response200PaymentInfoBrazilian., must be bigger than or equal to 0.');
        }
    ...
    public function setBranchCode($branchCode)
    {
        ...
        if ((!preg_match("/[0-9]+/", ObjectSerializer::toString($branchCode)))) {
            throw new \InvalidArgumentException("invalid value for \$branchCode when calling A01Response200PaymentInfoBrazilian., must conform to the pattern /[0-9]+/.");
        }
    ...
    public function setPixKey($pixKey)
    {
        ...
        if ((mb_strlen($pixKey) > 255)) {
            throw new \InvalidArgumentException('invalid length for $pixKey when calling A01Response200PaymentInfoBrazilian., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($pixKey) < 0)) {
            throw new \InvalidArgumentException('invalid length for $pixKey when calling A01Response200PaymentInfoBrazilian., must be bigger than or equal to 0.');
        }
