...
/**
 * A02RequestPaymentInfo Class Doc Comment
 *
 * @category Class
 ...
 */
class A02RequestPaymentInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'A02_Request_PaymentInfo';
    ...
    */
    ...
    public function setOwner($owner)
    {
        ...
        if ((mb_strlen($owner) > 100)) {
            throw new \InvalidArgumentException('invalid length for $owner when calling A02RequestPaymentInfo., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($owner) < 3)) {
            throw new \InvalidArgumentException('invalid length for $owner when calling A02RequestPaymentInfo., must be bigger than or equal to 3.');
        }
