<?php
/**
 * A02Response200UpdatedProducerIdentifiers
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * A02Response200UpdatedProducerIdentifiers Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client\Mirakl
 * @author   OpenAPI Generator team
 ...
 */
class A02Response200UpdatedProducerIdentifiers implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'A02_Response_200_Updated_ProducerIdentifiers';
    ...
    */
    ...
    public function setEprCategoryCode($eprCategoryCode)
    {
        ...
        if ((mb_strlen($eprCategoryCode) > 255)) {
            throw new \InvalidArgumentException('invalid length for $eprCategoryCode when calling A02Response200UpdatedProducerIdentifiers., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($eprCategoryCode) < 0)) {
            throw new \InvalidArgumentException('invalid length for $eprCategoryCode when calling A02Response200UpdatedProducerIdentifiers., must be bigger than or equal to 0.');
        }
    ...
    public function setProducerId($producerId)
    {
        ...
        if ((mb_strlen($producerId) > 255)) {
            throw new \InvalidArgumentException('invalid length for $producerId when calling A02Response200UpdatedProducerIdentifiers., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($producerId) < 0)) {
            throw new \InvalidArgumentException('invalid length for $producerId when calling A02Response200UpdatedProducerIdentifiers., must be bigger than or equal to 0.');
        }
