...
/**
 * A01Response200PaymentInfo Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client\Mirakl
 * @author   OpenAPI Generator team
 ...
 */
class A01Response200PaymentInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'A01_Response_200_PaymentInfo';
    ...
    */
    ...
    public function setOwner($owner)
    {
        ...
        if ((mb_strlen($owner) > 100)) {
            throw new \InvalidArgumentException('invalid length for $owner when calling A01Response200PaymentInfo., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($owner) < 3)) {
            throw new \InvalidArgumentException('invalid length for $owner when calling A01Response200PaymentInfo., must be bigger than or equal to 3.');
        }
