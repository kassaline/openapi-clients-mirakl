...
/**
 * AcceptOrderLine Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client\Mirakl
 * @author   OpenAPI Generator team
 ...
 */
class AcceptOrderLine implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AcceptOrderLine';
    ...
    */
     ...
     * Sets accepted
     *
     * @param bool|null $accepted Indicates if an order line is accepted (true) or refused (false).
     *
     * @return self
     */
