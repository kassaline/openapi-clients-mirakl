...
/**
 * A02RequestProDetails Class Doc Comment
 *
 * @category Class
 ...
 */
class A02RequestProDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'A02_Request_ProDetails';
    ...
    */
     ...
     * Sets corporateName
     *
     * @param string|null $corporateName Corporate name of the shop. Not nullable.
     *
     * @return self
     */
     ...
     *
     * @param string|null $identificationNumber Identification number of the shop. For France it would be the SIRET. Only nullable if the country_iso_code corresponds to USA.
     *
     * @return self
     */
     ...
     *
     * @param string|null $taxIdentificationNumber Tax identification number of the shop. Nullable.
     *
     * @return self
     */
