...
/**
 * OF22Response200EcoContributions Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client\Mirakl
 * @author   OpenAPI Generator team
 ...
 */
class OF22Response200EcoContributions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OF22_Response_200_EcoContributions';
    ...
    */
    ...
    public function setEprCategoryCode($eprCategoryCode)
    {
        ...
        if ((mb_strlen($eprCategoryCode) > 255)) {
            throw new \InvalidArgumentException('invalid length for $eprCategoryCode when calling OF22Response200EcoContributions., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($eprCategoryCode) < 0)) {
            throw new \InvalidArgumentException('invalid length for $eprCategoryCode when calling OF22Response200EcoContributions., must be bigger than or equal to 0.');
        }
    ...
    public function setProducerId($producerId)
    {
        ...
        if ((mb_strlen($producerId) > 255)) {
            throw new \InvalidArgumentException('invalid length for $producerId when calling OF22Response200EcoContributions., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($producerId) < 0)) {
            throw new \InvalidArgumentException('invalid length for $producerId when calling OF22Response200EcoContributions., must be bigger than or equal to 0.');
        }
