...
class ProductIdentifier implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) > 256)) {
            throw new \InvalidArgumentException('invalid length for $id when calling ProductIdentifier., must be smaller than or equal to 256.');
        }
        if ((mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling ProductIdentifier., must be bigger than or equal to 1.');
        }
