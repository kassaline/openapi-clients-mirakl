...
/**
 * RT04Response200ReturnErrors Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client\Mirakl
 * @author   OpenAPI Generator team
 ...
 */
class RT04Response200ReturnErrors implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RT04_Response_200_ReturnErrors';
    ...
    */
     ...
     * Sets message
     *
     * @param string|null $message Return creation error message
     *
     * @return self
     */
     ...
     *
     * @param string|null $orderCommercialId Order commercial id of failed return creations
     *
     * @return self
     */
