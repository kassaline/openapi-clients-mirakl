...
/**
 * OR30RequestCancelations Class Doc Comment
 *
 * @category Class
 ...
 */
class OR30RequestCancelations implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OR30_Request_Cancelations';
    ...
    protected static $openAPITypes = [
        ...
        'fees' => '\OpenAPI\Client\Mirakl\Model\OR30RequestCancelationsFees[]',
        'orderLineId' => 'string',
        'quantity' => 'int',
        'reasonCode' => 'string',
        'shippingAmount' => 'float',
        'shippingTaxes' => '\OpenAPI\Client\Mirakl\Model\OR30RequestCancelationsShippingTaxes[]',
        'taxes' => '\OpenAPI\Client\Mirakl\Model\OR30RequestCancelationsTaxes[]'
    ];
    ...
    */
     ...
     * Sets amount
     *
     * @param float|null $amount The offer part amount to be canceled
     *
     * @return self
     */
     ...
     * Gets fees
     *
     * @return \OpenAPI\Client\Mirakl\Model\OR30RequestCancelationsFees[]|null
     */
     ...
     * Sets fees
     *
     * @param \OpenAPI\Client\Mirakl\Model\OR30RequestCancelationsFees[]|null $fees The fees to be canceled
     *
     * @return self
     */
     ...
     * Sets orderLineId
     *
     * @param string|null $orderLineId Order line's identifier that must be canceled
     *
     * @return self
     */
     ...
     * Sets quantity
     *
     * @param int|null $quantity The quantity of goods to cancel
     *
     * @return self
     */
     ...
     * Sets shippingAmount
     *
     * @param float|null $shippingAmount The shipping charges part amount to be canceled
     *
     * @return self
     */
     ...
     * Gets shippingTaxes
     *
     * @return \OpenAPI\Client\Mirakl\Model\OR30RequestCancelationsShippingTaxes[]|null
     */
     ...
     * Sets shippingTaxes
     *
     * @param \OpenAPI\Client\Mirakl\Model\OR30RequestCancelationsShippingTaxes[]|null $shippingTaxes The taxes to be canceled on the shipping price (this field is required if the order has shipping taxes)
     *
     * @return self
     */
     ...
     * Gets taxes
     *
     * @return \OpenAPI\Client\Mirakl\Model\OR30RequestCancelationsTaxes[]|null
     */
     ...
     * Sets taxes
     *
     * @param \OpenAPI\Client\Mirakl\Model\OR30RequestCancelationsTaxes[]|null $taxes The taxes to be canceled on the product price (this field is required if the order has taxes)
     *
     * @return self
     */
