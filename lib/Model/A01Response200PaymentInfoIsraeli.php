<?php
/**
 * A01Response200PaymentInfoIsraeli
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * A01Response200PaymentInfoIsraeli Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client\Mirakl
 * @author   OpenAPI Generator team
 ...
 */
class A01Response200PaymentInfoIsraeli extends A01Response200PaymentInfo
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'A01_Response_200_PaymentInfo_Israeli';
    ...
    */
    ...
    public function setBankAccountNumber($bankAccountNumber)
    {
        ...
        if ((mb_strlen($bankAccountNumber) > 9)) {
            throw new \InvalidArgumentException('invalid length for $bankAccountNumber when calling A01Response200PaymentInfoIsraeli., must be smaller than or equal to 9.');
        }
        if ((mb_strlen($bankAccountNumber) < 1)) {
            throw new \InvalidArgumentException('invalid length for $bankAccountNumber when calling A01Response200PaymentInfoIsraeli., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/[0-9]+/", ObjectSerializer::toString($bankAccountNumber)))) {
            throw new \InvalidArgumentException("invalid value for \$bankAccountNumber when calling A01Response200PaymentInfoIsraeli., must conform to the pattern /[0-9]+/.");
        }
    ...
    public function setBankCity($bankCity)
    {
        ...
        if ((mb_strlen($bankCity) > 100)) {
            throw new \InvalidArgumentException('invalid length for $bankCity when calling A01Response200PaymentInfoIsraeli., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($bankCity) < 3)) {
            throw new \InvalidArgumentException('invalid length for $bankCity when calling A01Response200PaymentInfoIsraeli., must be bigger than or equal to 3.');
        }
    ...
    public function setBankCode($bankCode)
    {
        ...
        if ((mb_strlen($bankCode) > 4)) {
            throw new \InvalidArgumentException('invalid length for $bankCode when calling A01Response200PaymentInfoIsraeli., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($bankCode) < 1)) {
            throw new \InvalidArgumentException('invalid length for $bankCode when calling A01Response200PaymentInfoIsraeli., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/[0-9]+/", ObjectSerializer::toString($bankCode)))) {
            throw new \InvalidArgumentException("invalid value for \$bankCode when calling A01Response200PaymentInfoIsraeli., must conform to the pattern /[0-9]+/.");
        }
    ...
    public function setBankName($bankName)
    {
        ...
        if ((mb_strlen($bankName) > 255)) {
            throw new \InvalidArgumentException('invalid length for $bankName when calling A01Response200PaymentInfoIsraeli., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($bankName) < 0)) {
            throw new \InvalidArgumentException('invalid length for $bankName when calling A01Response200PaymentInfoIsraeli., must be bigger than or equal to 0.');
        }
    ...
    public function setBankStreet($bankStreet)
    {
        ...
        if ((mb_strlen($bankStreet) > 100)) {
            throw new \InvalidArgumentException('invalid length for $bankStreet when calling A01Response200PaymentInfoIsraeli., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($bankStreet) < 3)) {
            throw new \InvalidArgumentException('invalid length for $bankStreet when calling A01Response200PaymentInfoIsraeli., must be bigger than or equal to 3.');
        }
    ...
    public function setBankZip($bankZip)
    {
        ...
        if ((mb_strlen($bankZip) > 255)) {
            throw new \InvalidArgumentException('invalid length for $bankZip when calling A01Response200PaymentInfoIsraeli., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($bankZip) < 0)) {
            throw new \InvalidArgumentException('invalid length for $bankZip when calling A01Response200PaymentInfoIsraeli., must be bigger than or equal to 0.');
        }
