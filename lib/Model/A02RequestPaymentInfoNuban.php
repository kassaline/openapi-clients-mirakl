...
/**
 * A02RequestPaymentInfoNuban Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client\Mirakl
 * @author   OpenAPI Generator team
 ...
 */
class A02RequestPaymentInfoNuban extends A02RequestPaymentInfo
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'A02_Request_PaymentInfo_Nuban';
    ...
    */
    ...
    public function setBankCity($bankCity)
    {
        ...
        if ((mb_strlen($bankCity) > 100)) {
            throw new \InvalidArgumentException('invalid length for $bankCity when calling A02RequestPaymentInfoNuban., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($bankCity) < 3)) {
            throw new \InvalidArgumentException('invalid length for $bankCity when calling A02RequestPaymentInfoNuban., must be bigger than or equal to 3.');
        }
    ...
    public function setBankName($bankName)
    {
        ...
        if ((mb_strlen($bankName) > 255)) {
            throw new \InvalidArgumentException('invalid length for $bankName when calling A02RequestPaymentInfoNuban., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($bankName) < 0)) {
            throw new \InvalidArgumentException('invalid length for $bankName when calling A02RequestPaymentInfoNuban., must be bigger than or equal to 0.');
        }
    ...
    public function setBankStreet($bankStreet)
    {
        ...
        if ((mb_strlen($bankStreet) > 100)) {
            throw new \InvalidArgumentException('invalid length for $bankStreet when calling A02RequestPaymentInfoNuban., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($bankStreet) < 3)) {
            throw new \InvalidArgumentException('invalid length for $bankStreet when calling A02RequestPaymentInfoNuban., must be bigger than or equal to 3.');
        }
    ...
    public function setBankZip($bankZip)
    {
        ...
        if ((mb_strlen($bankZip) > 255)) {
            throw new \InvalidArgumentException('invalid length for $bankZip when calling A02RequestPaymentInfoNuban., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($bankZip) < 0)) {
            throw new \InvalidArgumentException('invalid length for $bankZip when calling A02RequestPaymentInfoNuban., must be bigger than or equal to 0.');
        }
    ...
    public function setNuban($nuban)
    {
        ...
        if ((mb_strlen($nuban) > 255)) {
            throw new \InvalidArgumentException('invalid length for $nuban when calling A02RequestPaymentInfoNuban., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($nuban) < 10)) {
            throw new \InvalidArgumentException('invalid length for $nuban when calling A02RequestPaymentInfoNuban., must be bigger than or equal to 10.');
        }
