...
/**
 * A02Response200UpdatedPaymentInfoCanadian Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client\Mirakl
 * @author   OpenAPI Generator team
 ...
 */
class A02Response200UpdatedPaymentInfoCanadian extends A02Response200UpdatedPaymentInfo
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'A02_Response_200_Updated_PaymentInfo_Canadian';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['bankAccountNumber']) && (mb_strlen($this->container['bankAccountNumber']) < 5)) {
            $invalidProperties[] = "invalid value for 'bankAccountNumber', the character length must be bigger than or equal to 5.";
        }
        ...
        if (!is_null($this->container['institutionNumber']) && !preg_match("/[0-9]+/", $this->container['institutionNumber'])) {
            $invalidProperties[] = "invalid value for 'institutionNumber', must be conform to the pattern /[0-9]+/.";
        }

        if (!is_null($this->container['transitNumber']) && !preg_match("/[0-9]+/", $this->container['transitNumber'])) {
            $invalidProperties[] = "invalid value for 'transitNumber', must be conform to the pattern /[0-9]+/.";
        }
    ...
    public function setBankAccountNumber($bankAccountNumber)
    {
        ...
        if ((mb_strlen($bankAccountNumber) > 12)) {
            throw new \InvalidArgumentException('invalid length for $bankAccountNumber when calling A02Response200UpdatedPaymentInfoCanadian., must be smaller than or equal to 12.');
        }
        if ((mb_strlen($bankAccountNumber) < 5)) {
            throw new \InvalidArgumentException('invalid length for $bankAccountNumber when calling A02Response200UpdatedPaymentInfoCanadian., must be bigger than or equal to 5.');
        }
        if ((!preg_match("/[0-9]+/", ObjectSerializer::toString($bankAccountNumber)))) {
            throw new \InvalidArgumentException("invalid value for \$bankAccountNumber when calling A02Response200UpdatedPaymentInfoCanadian., must conform to the pattern /[0-9]+/.");
        }
    ...
    public function setBankCity($bankCity)
    {
        ...
        if ((mb_strlen($bankCity) > 100)) {
            throw new \InvalidArgumentException('invalid length for $bankCity when calling A02Response200UpdatedPaymentInfoCanadian., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($bankCity) < 3)) {
            throw new \InvalidArgumentException('invalid length for $bankCity when calling A02Response200UpdatedPaymentInfoCanadian., must be bigger than or equal to 3.');
        }
    ...
    public function setBankName($bankName)
    {
        ...
        if ((mb_strlen($bankName) > 255)) {
            throw new \InvalidArgumentException('invalid length for $bankName when calling A02Response200UpdatedPaymentInfoCanadian., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($bankName) < 0)) {
            throw new \InvalidArgumentException('invalid length for $bankName when calling A02Response200UpdatedPaymentInfoCanadian., must be bigger than or equal to 0.');
        }
    ...
    public function setBankStreet($bankStreet)
    {
        ...
        if ((mb_strlen($bankStreet) > 100)) {
            throw new \InvalidArgumentException('invalid length for $bankStreet when calling A02Response200UpdatedPaymentInfoCanadian., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($bankStreet) < 3)) {
            throw new \InvalidArgumentException('invalid length for $bankStreet when calling A02Response200UpdatedPaymentInfoCanadian., must be bigger than or equal to 3.');
        }
    ...
    public function setBankZip($bankZip)
    {
        ...
        if ((mb_strlen($bankZip) > 255)) {
            throw new \InvalidArgumentException('invalid length for $bankZip when calling A02Response200UpdatedPaymentInfoCanadian., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($bankZip) < 0)) {
            throw new \InvalidArgumentException('invalid length for $bankZip when calling A02Response200UpdatedPaymentInfoCanadian., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param string|null $institutionNumber Bank institution number
     *
     * @return self
     */
    public function setInstitutionNumber($institutionNumber)
    {
        ...
        if ((!preg_match("/[0-9]+/", ObjectSerializer::toString($institutionNumber)))) {
            throw new \InvalidArgumentException("invalid value for \$institutionNumber when calling A02Response200UpdatedPaymentInfoCanadian., must conform to the pattern /[0-9]+/.");
        }
     ...
     * Sets transitNumber
     *
     * @param string|null $transitNumber Bank transit number
     *
     * @return self
     */
    public function setTransitNumber($transitNumber)
    {
        ...
        if ((!preg_match("/[0-9]+/", ObjectSerializer::toString($transitNumber)))) {
            throw new \InvalidArgumentException("invalid value for \$transitNumber when calling A02Response200UpdatedPaymentInfoCanadian., must conform to the pattern /[0-9]+/.");
        }
