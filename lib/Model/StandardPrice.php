...
/**
 * StandardPrice Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client\Mirakl
 * @author   OpenAPI Generator team
 ...
 */
class StandardPrice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StandardPrice';
    ...
    */
    ...
    public function setScope($scope)
    {
        ...
        if ((mb_strlen($scope) > 255)) {
            throw new \InvalidArgumentException('invalid length for $scope when calling StandardPrice., must be smaller than or equal to 255.');
        }
