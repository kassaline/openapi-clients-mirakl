<?php
/**
 * A01Response200PaymentInfoNzbsb
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * A01Response200PaymentInfoNzbsb Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client\Mirakl
 * @author   OpenAPI Generator team
 ...
 */
class A01Response200PaymentInfoNzbsb extends A01Response200PaymentInfo
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'A01_Response_200_PaymentInfo_Nzbsb';
    ...
    */
    ...
    public function setBankCity($bankCity)
    {
        ...
        if ((mb_strlen($bankCity) > 100)) {
            throw new \InvalidArgumentException('invalid length for $bankCity when calling A01Response200PaymentInfoNzbsb., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($bankCity) < 3)) {
            throw new \InvalidArgumentException('invalid length for $bankCity when calling A01Response200PaymentInfoNzbsb., must be bigger than or equal to 3.');
        }
    ...
    public function setBankName($bankName)
    {
        ...
        if ((mb_strlen($bankName) > 255)) {
            throw new \InvalidArgumentException('invalid length for $bankName when calling A01Response200PaymentInfoNzbsb., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($bankName) < 0)) {
            throw new \InvalidArgumentException('invalid length for $bankName when calling A01Response200PaymentInfoNzbsb., must be bigger than or equal to 0.');
        }
    ...
    public function setBankStreet($bankStreet)
    {
        ...
        if ((mb_strlen($bankStreet) > 100)) {
            throw new \InvalidArgumentException('invalid length for $bankStreet when calling A01Response200PaymentInfoNzbsb., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($bankStreet) < 3)) {
            throw new \InvalidArgumentException('invalid length for $bankStreet when calling A01Response200PaymentInfoNzbsb., must be bigger than or equal to 3.');
        }
    ...
    public function setBankZip($bankZip)
    {
        ...
        if ((mb_strlen($bankZip) > 255)) {
            throw new \InvalidArgumentException('invalid length for $bankZip when calling A01Response200PaymentInfoNzbsb., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($bankZip) < 0)) {
            throw new \InvalidArgumentException('invalid length for $bankZip when calling A01Response200PaymentInfoNzbsb., must be bigger than or equal to 0.');
        }
    ...
    public function setNzban($nzban)
    {
        ...
        if ((mb_strlen($nzban) > 10)) {
            throw new \InvalidArgumentException('invalid length for $nzban when calling A01Response200PaymentInfoNzbsb., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($nzban) < 10)) {
            throw new \InvalidArgumentException('invalid length for $nzban when calling A01Response200PaymentInfoNzbsb., must be bigger than or equal to 10.');
        }
