...
class OR32Response200OrderLinesAdjustedRefunds implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'ecoContributions' => '\OpenAPI\Client\Mirakl\Model\OR32Response200OrderLinesAdjustedRefundsEcoContributions[]',
        'quantity' => 'int',
        'reasonCode' => 'string',
        'shippingAmount' => 'float',
        'shippingTaxes' => '\OpenAPI\Client\Mirakl\Model\OR32Response200OrderLinesAdjustedRefundsShippingTaxes[]',
        'taxes' => '\OpenAPI\Client\Mirakl\Model\OR32Response200OrderLinesAdjustedRefundsTaxes[]'
    ];
    ...
    */
     ...
     *
     * @return \OpenAPI\Client\Mirakl\Model\OR32Response200OrderLinesAdjustedRefundsEcoContributions[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Mirakl\Model\OR32Response200OrderLinesAdjustedRefundsEcoContributions[]|null $ecoContributions List of eco-contribution amounts and corresponding producer identifiers, if applicable<br/> Only available if the operator activates the circular economy information collection.
     *
     * @return self
     */
     ...
     * Sets shippingAmount
     *
     * @param float|null $shippingAmount The shipping charges part amount refunded
     *
     * @return self
     */
     ...
     * Gets shippingTaxes
     *
     * @return \OpenAPI\Client\Mirakl\Model\OR32Response200OrderLinesAdjustedRefundsShippingTaxes[]|null
     */
     ...
     * Sets shippingTaxes
     *
     * @param \OpenAPI\Client\Mirakl\Model\OR32Response200OrderLinesAdjustedRefundsShippingTaxes[]|null $shippingTaxes The taxes refunded on the shipping price
     *
     * @return self
     */
     ...
     * Gets taxes
     *
     * @return \OpenAPI\Client\Mirakl\Model\OR32Response200OrderLinesAdjustedRefundsTaxes[]|null
     */
     ...
     * Sets taxes
     *
     * @param \OpenAPI\Client\Mirakl\Model\OR32Response200OrderLinesAdjustedRefundsTaxes[]|null $taxes The taxes refunded on the product price
     *
     * @return self
     */
