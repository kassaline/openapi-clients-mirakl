...
/**
 * A02Response200UpdatedPaymentInfoIndian Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client\Mirakl
 * @author   OpenAPI Generator team
 ...
 */
class A02Response200UpdatedPaymentInfoIndian extends A02Response200UpdatedPaymentInfo
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'A02_Response_200_Updated_PaymentInfo_Indian';
    ...
    protected static array $openAPINullables = [
        ...
        'bankStreet' => false,
        'bankZip' => false,
        'indianFinancialSystemCode' => false,
        'swiftCode' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'bankZip' => 'bank_zip',
        'indianFinancialSystemCode' => 'indian_financial_system_code',
    ...
    protected static $setters = [
        ...
        'bankZip' => 'setBankZip',
        'indianFinancialSystemCode' => 'setIndianFinancialSystemCode',
    ...
    protected static $getters = [
        ...
        'bankZip' => 'getBankZip',
        'indianFinancialSystemCode' => 'getIndianFinancialSystemCode',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('indianFinancialSystemCode', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['accountNumber']) && !preg_match("/[0-9a-zA-Z]+/", $this->container['accountNumber'])) {
            $invalidProperties[] = "invalid value for 'accountNumber', must be conform to the pattern /[0-9a-zA-Z]+/.";
        }
    ...
    public function setAccountNumber($accountNumber)
    {
        ...
        if ((mb_strlen($accountNumber) > 20)) {
            throw new \InvalidArgumentException('invalid length for $accountNumber when calling A02Response200UpdatedPaymentInfoIndian., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($accountNumber) < 6)) {
            throw new \InvalidArgumentException('invalid length for $accountNumber when calling A02Response200UpdatedPaymentInfoIndian., must be bigger than or equal to 6.');
        }
        if ((!preg_match("/[0-9a-zA-Z]+/", ObjectSerializer::toString($accountNumber)))) {
            throw new \InvalidArgumentException("invalid value for \$accountNumber when calling A02Response200UpdatedPaymentInfoIndian., must conform to the pattern /[0-9a-zA-Z]+/.");
        }
    ...
    public function setBankCity($bankCity)
    {
        ...
        if ((mb_strlen($bankCity) > 100)) {
            throw new \InvalidArgumentException('invalid length for $bankCity when calling A02Response200UpdatedPaymentInfoIndian., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($bankCity) < 3)) {
            throw new \InvalidArgumentException('invalid length for $bankCity when calling A02Response200UpdatedPaymentInfoIndian., must be bigger than or equal to 3.');
        }
    ...
    public function setBankName($bankName)
    {
        ...
        if ((mb_strlen($bankName) > 255)) {
            throw new \InvalidArgumentException('invalid length for $bankName when calling A02Response200UpdatedPaymentInfoIndian., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($bankName) < 0)) {
            throw new \InvalidArgumentException('invalid length for $bankName when calling A02Response200UpdatedPaymentInfoIndian., must be bigger than or equal to 0.');
        }
    ...
    public function setBankStreet($bankStreet)
    {
        ...
        if ((mb_strlen($bankStreet) > 100)) {
            throw new \InvalidArgumentException('invalid length for $bankStreet when calling A02Response200UpdatedPaymentInfoIndian., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($bankStreet) < 3)) {
            throw new \InvalidArgumentException('invalid length for $bankStreet when calling A02Response200UpdatedPaymentInfoIndian., must be bigger than or equal to 3.');
        }
    ...
    public function setBankZip($bankZip)
    {
        ...
        if ((mb_strlen($bankZip) > 255)) {
            throw new \InvalidArgumentException('invalid length for $bankZip when calling A02Response200UpdatedPaymentInfoIndian., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($bankZip) < 0)) {
            throw new \InvalidArgumentException('invalid length for $bankZip when calling A02Response200UpdatedPaymentInfoIndian., must be bigger than or equal to 0.');
        }
    ...
    /**
     * Gets indianFinancialSystemCode
     *
     * @return string|null
     */
    public function getIndianFinancialSystemCode()
    {
        return $this->container['indianFinancialSystemCode'];
    }

    /**
     * Sets indianFinancialSystemCode
     *
     * @param string|null $indianFinancialSystemCode Indian financial system code
     *
     * @return self
     */
    public function setIndianFinancialSystemCode($indianFinancialSystemCode)
    {
        if (is_null($indianFinancialSystemCode)) {
            throw new \InvalidArgumentException('non-nullable indianFinancialSystemCode cannot be null');
        }
        $this->container['indianFinancialSystemCode'] = $indianFinancialSystemCode;
